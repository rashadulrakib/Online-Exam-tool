<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CandidateLogin.aspx.cs" Inherits="CandidateLogin" %>
        ...
        <tr>
			...
			<table cellpadding="0" cellspacing="0" style=" margin:0" border="0">
			    <tr>
			        <td style="text-align:left">
			            <asp:ValidationSummary id="vsCandidate" runat="server" HeaderText="Following fields missing or invalid"></asp:ValidationSummary>
			        </td> 
			    </tr>
			    <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" style=" margin:0" border="0">
                            <tr>
                                ...
                                <td colspan="3" style="vertical-align: top; height: 20px;" align="left" valign="top" bgcolor="#b0e0e6">
                                    <asp:Label ID="Label3" runat="server" Text="Cndidate Login" Font-Bold="True"></asp:Label>
                                </td>
            ...
            <tr>
                ...
                <td style="vertical-align: top; text-align: left">
                    <asp:Label ID="Label1" runat="server" Style="text-align: left" Text="Email Address"></asp:Label></td>
                <td style="vertical-align: top; text-align: left;width:5px">
                </td>
                <td style="vertical-align: top;  text-align: left">
                    <asp:TextBox ID="txt_LoginName" runat="server" Width="150px" MaxLength="100"></asp:TextBox><span style="color: #ff0000">*</span></td>
                <td style="vertical-align: top; text-align: left;width:10px">
                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txt_LoginName"
                        Display="None" ErrorMessage="Email Address required." SetFocusOnError="True"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                            ID="revEmail" runat="server" ControlToValidate="txt_LoginName" Display="None"
                            ErrorMessage="Invalid Email Address" SetFocusOnError="True" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator></td>
            </tr>
            <tr>
                <td style=" height:1px">
